...
Model::Model(ID3D11Device* device, ID3D11DeviceContext* deviceContext, char* filename)
{
	loadModel(filename);
	initBuffers(device);
}
...
void Model::calculateTangentAndBinormal(ModelType vertex1, ModelType vertex2, ModelType vertex3, XMFLOAT3 & tangent, XMFLOAT3 & binormal)
{
